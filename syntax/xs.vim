...
" Last Change: Fri Mar 16 13:46:45 2012 UTC
...
if exists("xs_not_core") && xs_not_core
    ...
    syn keyword xsPrivate Perl_get_re_arg Perl_is_utf8_X_L Perl_is_utf8_X_LV
    syn keyword xsPrivate Perl_is_utf8_X_LVT Perl_is_utf8_X_LV_LVT_V
    syn keyword xsPrivate Perl_is_utf8_X_T Perl_is_utf8_X_V Perl_is_utf8_X_begin
    syn keyword xsPrivate Perl_is_utf8_X_extend Perl_is_utf8_X_non_hangul
    syn keyword xsPrivate Perl_is_utf8_X_prepend Perl_mod
    ...
    syn keyword xsPrivate S_add_alternate S_add_data S_add_range_to_invlist
    syn keyword xsPrivate S_add_utf16_textfilter S_amagic_cmp S_amagic_cmp_locale
    syn keyword xsPrivate S_amagic_i_ncmp S_amagic_ncmp S_anonymise_cv_maybe S_ao
    syn keyword xsPrivate S_apply_attrs S_apply_attrs_my
    syn keyword xsPrivate S_assert_uft8_cache_coherent S_bad_type S_bytes_to_uni
    syn keyword xsPrivate S_check_type_and_open S_check_uni S_checkcomma
    syn keyword xsPrivate S_checkposixcc S_ckwarn_common S_cl_and S_cl_anything
    syn keyword xsPrivate S_cl_init S_cl_is_anything S_cl_or S_clear_placeholders
    syn keyword xsPrivate S_closest_cop S_cop_free S_cr_textfilter S_curmad
    ...
    syn keyword xsPrivate S_find_and_forget_pmops S_find_array_subscript
    syn keyword xsPrivate S_find_beginning S_find_byclass S_find_hash_subscript
    syn keyword xsPrivate S_find_in_my_stash S_find_uninit_var S_first_symbol
    syn keyword xsPrivate S_fold_constants S_forbid_setid S_force_ident
    syn keyword xsPrivate S_force_list S_force_next S_force_strict_version
    syn keyword xsPrivate S_force_version S_force_word S_forget_pmop
    syn keyword xsPrivate S_gen_constant_list S_get_aux_mg S_get_num
    syn keyword xsPrivate S_glob_2number S_glob_assign_glob S_glob_assign_ref
    syn keyword xsPrivate S_grok_bslash_c S_grok_bslash_o S_group_end S_gv_ename
    syn keyword xsPrivate S_gv_get_super_pkg S_gv_init_sv S_gv_magicalize_isa
    syn keyword xsPrivate S_gv_magicalize_overload S_hfreeentries S_hsplit
    syn keyword xsPrivate S_hv_auxinit S_hv_delete_common S_hv_magic_check
    syn keyword xsPrivate S_hv_notallowed S_incline S_incpush S_incpush_if_exists
    ...
    syn keyword xsPrivate S_invlist_intersection S_invlist_union
    syn keyword xsPrivate S_invoke_exception_hook S_is_an_int
    syn keyword xsPrivate S_is_handle_constructor S_is_inplace_av
    syn keyword xsPrivate S_is_list_assignment S_is_utf8_char_slow
    syn keyword xsPrivate S_is_utf8_common S_isa_lookup S_join_exact S_listkids
    syn keyword xsPrivate S_looks_like_bool S_magic_methcall1 S_make_matcher
    syn keyword xsPrivate S_make_trie S_make_trie_failtable S_matcher_matches_sv
    ...
    syn keyword xsPrivate S_pad_add_name_sv S_pad_check_dup S_pad_findlex
    ...
    syn keyword xsPrivate _append_range_to_invlist _new_invlist
    syn keyword xsPrivate _swash_inversion_hash _swash_to_invlist add_alternate
    syn keyword xsPrivate add_cp_to_invlist add_data add_range_to_invlist
    syn keyword xsPrivate add_utf16_textfilter amagic_cmp amagic_cmp_locale
    ...
    syn keyword xsPrivate filter_gets find_and_forget_pmops find_array_subscript
    syn keyword xsPrivate find_beginning find_byclass find_hash_subscript
    syn keyword xsPrivate find_in_my_stash find_rundefsvoffset find_uninit_var
    syn keyword xsPrivate first_symbol fold_constants forbid_setid force_ident
    syn keyword xsPrivate force_list force_next force_strict_version
    syn keyword xsPrivate force_version force_word gen_constant_list get_aux_mg
    ...
    syn keyword xsPrivate gv_get_super_pkg gv_init_sv gv_magicalize_isa
    syn keyword xsPrivate gv_magicalize_overload hfreeentries hsplit hv_auxinit
    syn keyword xsPrivate hv_delete_common hv_magic_check hv_notallowed incline
    ...
    syn keyword xsPrivate intuit_method intuit_more invlist_array invlist_destroy
    syn keyword xsPrivate invlist_extend invlist_intersection invlist_len
    syn keyword xsPrivate invlist_max invlist_set_len invlist_set_max
    syn keyword xsPrivate invlist_trim invlist_union invoke_exception_hook
    syn keyword xsPrivate is_an_int is_handle_constructor is_inplace_av
    ...
    syn keyword xsPrivate is_utf8_X_non_hangul is_utf8_X_prepend
    ...
    syn keyword xsPrivate measure_struct mem_log_common mess_alloc method_common
    syn keyword xsPrivate missingterm mod modkids more_sv mro_clean_isarev
    syn keyword xsPrivate mro_gather_and_rename mro_get_linear_isa_dfs mul128
    syn keyword xsPrivate mulexp10 my_exit_jump my_kid need_utf8 newDEFSVOP
    syn keyword xsPrivate newGIVWHENOP new_he new_logop next_symbol nextchar
    syn keyword xsPrivate no_bareword_allowed no_fh_allowed no_op not_a_number
    syn keyword xsPrivate nuke_stacks num_overflow op_clear open_script
    syn keyword xsPrivate opt_scalarhv pack_rec pad_add_name_sv pad_check_dup
    syn keyword xsPrivate pad_findlex pad_reset parse_body path_is_absolute
    syn keyword xsPrivate pidgone pm_description pmtrans printbuf
    syn keyword xsPrivate process_special_blocks ptr_table_clear ptr_table_find
    syn keyword xsPrivate put_byte qerror qsortsvu re_croak2 readpipe_override
    ...
    syn keyword xsPrivate sv_2iuv_non_preserve sv_add_arena sv_compile_2op
    syn keyword xsPrivate sv_dup_common sv_dup_inc_multiple sv_exp_grow sv_i_ncmp
    syn keyword xsPrivate sv_ncmp sv_pos_b2u_midway sv_pos_u2b_cached
    syn keyword xsPrivate sv_pos_u2b_forwards sv_pos_u2b_midway sv_release_COW
    syn keyword xsPrivate sv_setsv_cow sv_unglob swallow_bom swash_get
    syn keyword xsPrivate to_byte_substr to_utf8_substr tokenize_use tokeq
    syn keyword xsPrivate tokereport too_few_arguments too_many_arguments
    ...
    syn keyword xsPrivate varname visit vivify_defelem with_queued_errors
    syn keyword xsPrivate write_no_mem xmldump_attr yylex yywarn
endif
...
syn keyword xsConstant OP_AKEYS OP_ALARM OP_AND OP_ANDASSIGN OP_ANONCODE
syn keyword xsConstant OP_ANONHASH OP_ANONLIST OP_ASLICE OP_ATAN2
...
syn keyword xsConstant OP_CONST OP_CONTINUE OP_COS OP_CRYPT OP_CUSTOM
syn keyword xsConstant OP_DBMCLOSE OP_DBMOPEN OP_DBSTATE OP_DEFINED OP_DELETE
syn keyword xsConstant OP_DIE OP_DIVIDE OP_DOFILE OP_DOR OP_DORASSIGN OP_DUMP
...
syn keyword xsConstant OP_EXEC OP_EXISTS OP_EXIT OP_EXP OP_FCNTL OP_FILENO
syn keyword xsConstant OP_FLIP OP_FLOCK OP_FLOP OP_FORK OP_FORMLINE
...
syn keyword xsConstant OP_INDEX OP_INT OP_IOCTL OP_ITER OP_I_ADD OP_I_DIVIDE
syn keyword xsConstant OP_I_EQ OP_I_GE OP_I_GT OP_I_LE OP_I_LT OP_I_MODULO
syn keyword xsConstant OP_I_MULTIPLY OP_I_NCMP OP_I_NE OP_I_NEGATE
syn keyword xsConstant OP_I_POSTDEC OP_I_POSTINC OP_I_PREDEC OP_I_PREINC
syn keyword xsConstant OP_I_SUBTRACT OP_JOIN OP_KEYS OP_KILL OP_LAST OP_LC
syn keyword xsConstant OP_LCFIRST OP_LE OP_LEAVE OP_LEAVEEVAL OP_LEAVEGIVEN
syn keyword xsConstant OP_LEAVELOOP OP_LEAVESUB OP_LEAVESUBLV OP_LEAVETRY
syn keyword xsConstant OP_LEAVEWHEN OP_LEAVEWRITE OP_LEFT_SHIFT OP_LENGTH
syn keyword xsConstant OP_LINESEQ OP_LINK OP_LIST OP_LISTEN OP_LOCALTIME
syn keyword xsConstant OP_LOCK OP_LOG OP_LSLICE OP_LSTAT OP_LT OP_MAPSTART
syn keyword xsConstant OP_MAPWHILE OP_MATCH OP_METHOD OP_METHOD_NAMED
syn keyword xsConstant OP_MKDIR OP_MODULO OP_MSGCTL OP_MSGGET OP_MSGRCV
syn keyword xsConstant OP_MSGSND OP_MULTIPLY OP_NCMP OP_NE OP_NEGATE OP_NEXT
syn keyword xsConstant OP_NEXTSTATE OP_NOT OP_NULL OP_OCT OP_ONCE OP_OPEN
syn keyword xsConstant OP_OPEN_DIR OP_OR OP_ORASSIGN OP_ORD OP_PACK OP_PADANY
syn keyword xsConstant OP_PADAV OP_PADHV OP_PADSV OP_PIPE_OP OP_POP OP_POS
syn keyword xsConstant OP_POSTDEC OP_POSTINC OP_POW OP_PREDEC OP_PREINC
syn keyword xsConstant OP_PRINT OP_PROTOTYPE OP_PRTF OP_PUSH OP_PUSHMARK
syn keyword xsConstant OP_PUSHRE OP_QR OP_QUOTEMETA OP_RAND OP_RANGE
syn keyword xsConstant OP_RCATLINE OP_REACH OP_READ OP_READDIR OP_READLINE
syn keyword xsConstant OP_READLINK OP_RECV OP_REDO OP_REF OP_REFGEN
...
syn keyword xsConstant OP_RMDIR OP_RV2AV OP_RV2CV OP_RV2GV OP_RV2HV OP_RV2SV
syn keyword xsConstant OP_RVALUES OP_SASSIGN OP_SAY OP_SCALAR OP_SCHOMP
syn keyword xsConstant OP_SCHOP OP_SCMP OP_SCOPE OP_SEEK OP_SEEKDIR OP_SELECT
syn keyword xsConstant OP_SEMCTL OP_SEMGET OP_SEMOP OP_SEND OP_SEQ OP_SETPGRP
syn keyword xsConstant OP_SETPRIORITY OP_SGE OP_SGRENT OP_SGT OP_SHIFT
syn keyword xsConstant OP_SHMCTL OP_SHMGET OP_SHMREAD OP_SHMWRITE OP_SHOSTENT
syn keyword xsConstant OP_SHUTDOWN OP_SIN OP_SLE OP_SLEEP OP_SLT
...
syn keyword xsConstant OPpASSIGN_COMMON OPpASSIGN_CV_TO_GV OPpCONST_ARYBASE
syn keyword xsConstant OPpCONST_BARE OPpCONST_ENTERED OPpCONST_NOVER
syn keyword xsConstant OPpCONST_SHORTCIRCUIT OPpCONST_STRICT OPpCONST_WARNING
syn keyword xsConstant OPpDEREF OPpDEREF_AV OPpDEREF_HV OPpDEREF_SV
syn keyword xsConstant OPpDEREFed OPpDONT_INIT_GV OPpEARLY_CV
syn keyword xsConstant OPpENTERSUB_AMPER OPpENTERSUB_DB OPpENTERSUB_HASTARG
syn keyword xsConstant OPpENTERSUB_INARGS OPpENTERSUB_NOMOD
...
syn keyword xsConstant OPpFT_STACKED OPpGREP_LEX OPpHUSH_VMSISH OPpITER_DEF
syn keyword xsConstant OPpITER_REVERSED OPpLIST_GUESSED OPpLVAL_DEFER
syn keyword xsConstant OPpLVAL_INTRO OPpMAYBE_LVSUB OPpMAY_RETURN_CONSTANT
...
syn keyword xsConstant PERL_MAGIC_UTF8_CACHESIZE PERL_MAGIC_arylen
...
syn keyword xsFunction Perl__to_uni_fold_flags Perl__to_utf8_fold_flags
...
syn keyword xsFunction Perl_clone_params_del Perl_clone_params_new Perl_croak
...
syn keyword xsFunction Perl_cv_const_sv Perl_cv_get_call_checker
syn keyword xsFunction Perl_cv_set_call_checker Perl_cv_undef Perl_cx_dump
syn keyword xsFunction Perl_cx_dup Perl_cxinc Perl_deb Perl_deb_nocontext
syn keyword xsFunction Perl_debop Perl_debprofdump Perl_debstack
syn keyword xsFunction Perl_debstackptrs Perl_delimcpy Perl_despatch_signals
syn keyword xsFunction Perl_die Perl_die_nocontext Perl_die_sv Perl_dirp_dup
...
syn keyword xsFunction Perl_fetch_cop_label Perl_filter_add Perl_filter_del
syn keyword xsFunction Perl_filter_read Perl_find_runcv Perl_find_rundefsv
syn keyword xsFunction Perl_foldEQ Perl_foldEQ_latin1 Perl_foldEQ_locale
...
syn keyword xsFunction Perl_op_free Perl_op_linklist Perl_op_lvalue
syn keyword xsFunction Perl_op_null Perl_op_prepend_elem Perl_op_refcnt_lock
syn keyword xsFunction Perl_op_refcnt_unlock Perl_op_scope Perl_pack_cat
syn keyword xsFunction Perl_packlist Perl_pad_findmy Perl_pad_sv
syn keyword xsFunction Perl_parse_arithexpr Perl_parse_barestmt
syn keyword xsFunction Perl_parse_block Perl_parse_fullexpr
syn keyword xsFunction Perl_parse_fullstmt Perl_parse_label
syn keyword xsFunction Perl_parse_listexpr Perl_parse_stmtseq
syn keyword xsFunction Perl_parse_termexpr Perl_parser_dup Perl_pmop_dump
syn keyword xsFunction Perl_pop_scope Perl_pregcomp Perl_pregexec
syn keyword xsFunction Perl_pregfree Perl_pregfree2 Perl_prescan_version
syn keyword xsFunction Perl_printf_nocontext Perl_ptr_table_fetch
syn keyword xsFunction Perl_ptr_table_free Perl_ptr_table_new
syn keyword xsFunction Perl_ptr_table_split Perl_ptr_table_store
syn keyword xsFunction Perl_push_scope Perl_pv_display Perl_pv_escape
syn keyword xsFunction Perl_pv_pretty Perl_pv_uni_display Perl_re_compile
...
syn keyword xsFunction av_make av_pop av_push av_shift av_store av_undef
syn keyword xsFunction av_unshift block_gimme bytes_cmp_utf8 bytes_from_utf8
...
syn keyword xsFunction custom_op_desc custom_op_name cv_const_sv
...
syn keyword xsFunction gv_autoload4 gv_check gv_const_sv gv_dump gv_efullname
syn keyword xsFunction gv_efullname4 gv_fetchfile gv_fetchfile_flags
syn keyword xsFunction gv_fetchmeth gv_fetchmeth_autoload
...
syn keyword xsFunction gv_stashpvn gv_stashsv he_dup hek_dup hv_clear
syn keyword xsFunction hv_clear_placeholders hv_common hv_common_key_len
syn keyword xsFunction hv_copy_hints_hv hv_delayfree_ent hv_free_ent
...
syn keyword xsFunction hv_scalar init_global_struct init_i18nl10n
...
syn keyword xsFunction is_utf8_ascii is_utf8_char is_utf8_cntrl is_utf8_digit
syn keyword xsFunction is_utf8_graph is_utf8_idcont is_utf8_idfirst
syn keyword xsFunction is_utf8_lower is_utf8_mark is_utf8_perl_space
syn keyword xsFunction is_utf8_perl_word is_utf8_posix_digit is_utf8_print
syn keyword xsFunction is_utf8_punct is_utf8_space is_utf8_string
syn keyword xsFunction is_utf8_string_loclen is_utf8_upper is_utf8_xdigit
syn keyword xsFunction is_utf8_xidcont is_utf8_xidfirst leave_scope
syn keyword xsFunction lex_bufutf8 lex_discard_to lex_grow_linestr
syn keyword xsFunction lex_next_chunk lex_peek_unichar lex_read_space
syn keyword xsFunction lex_read_to lex_read_unichar lex_start lex_stuff_pv
syn keyword xsFunction lex_stuff_pvn lex_stuff_sv lex_unstuff load_module
...
syn keyword xsFunction newCONDOP newCONSTSUB newCVREF newFORM newFOROP
syn keyword xsFunction newGIVENOP newGVOP newGVREF newGVgen newHVREF newHVhv
syn keyword xsFunction newLISTOP newLOGOP newLOOPEX newLOOPOP newMYSUB
syn keyword xsFunction newNULLLIST newOP newPADOP newPMOP newPROG newPVOP
syn keyword xsFunction newRANGE newRV newRV_noinc newSLICEOP newSTATEOP newSV
syn keyword xsFunction newSVOP newSVREF newSV_type newSVhek newSViv newSVnv
syn keyword xsFunction newSVpv newSVpv_share newSVpvf newSVpvf_nocontext
syn keyword xsFunction newSVpvn newSVpvn_flags newSVpvn_share newSVrv newSVsv
syn keyword xsFunction newSVuv newUNOP newWHENOP newWHILEOP newXS newXS_flags
...
syn keyword xsFunction op_linklist op_lvalue op_null op_prepend_elem
syn keyword xsFunction op_refcnt_lock op_refcnt_unlock op_scope pack_cat
syn keyword xsFunction packlist pad_findmy pad_sv parse_arithexpr
...
syn keyword xsFunction to_uni_upper to_uni_upper_lc to_utf8_case
syn keyword xsFunction to_utf8_lower to_utf8_title to_utf8_upper unlnk
...
syn keyword xsVariable MARK MY_CXT ORIGMARK PL_Argv PL_Cmd PL_DBcv PL_DBgv
syn keyword xsVariable PL_DBline PL_DBsignal PL_DBsingle PL_DBsub PL_DBtrace
syn keyword xsVariable PL_Dir PL_Env PL_LIO PL_Mem PL_MemParse PL_MemShared
syn keyword xsVariable PL_OpPtr PL_OpSlab PL_OpSpace PL_Proc PL_Sock PL_StdIO
syn keyword xsVariable PL_Sv PL_Vars PL_VarsPtr PL_Xpv PL_a2e
syn keyword xsVariable PL_amagic_generation PL_an PL_apiversion PL_argvgv
syn keyword xsVariable PL_argvout_stack PL_argvoutgv PL_basetime PL_beginav
syn keyword xsVariable PL_beginav_save PL_bincompat_options PL_bitcount
syn keyword xsVariable PL_block_type PL_blockhooks PL_body_arenas
syn keyword xsVariable PL_bodytarget PL_breakable_sub_gen PL_bufend PL_bufptr
syn keyword xsVariable PL_charclass PL_check PL_checkav PL_checkav_save
syn keyword xsVariable PL_chopset PL_clocktick PL_collation_ix
syn keyword xsVariable PL_collation_name PL_collation_standard
syn keyword xsVariable PL_collxfrm_base PL_collxfrm_mult PL_colorset
syn keyword xsVariable PL_compcv PL_compiling PL_comppad PL_comppad_name
syn keyword xsVariable PL_comppad_name_fill PL_comppad_name_floor
syn keyword xsVariable PL_cop_seqmax PL_copline PL_core_reg_engine
syn keyword xsVariable PL_cryptseen PL_cshname PL_curcop PL_curcopdb
syn keyword xsVariable PL_curforce PL_curpad PL_curpm PL_curstack
syn keyword xsVariable PL_curstackinfo PL_curstash PL_curstname
syn keyword xsVariable PL_custom_op_descs PL_custom_op_names PL_custom_ops
syn keyword xsVariable PL_cv_has_eval PL_dbargs PL_debstash PL_debug
syn keyword xsVariable PL_debug_pad PL_def_layerlist PL_defgv PL_defoutgv
syn keyword xsVariable PL_defstash PL_delaymagic PL_destroyhook PL_diehook
syn keyword xsVariable PL_doswitches PL_dowarn PL_dumper_fd PL_dumpindent
syn keyword xsVariable PL_e2a PL_e2utf PL_e_script PL_efloatbuf PL_efloatsize
syn keyword xsVariable PL_egid PL_encoding PL_endav PL_endwhite PL_envgv
syn keyword xsVariable PL_errgv PL_error_count PL_errors PL_euid PL_eval_root
syn keyword xsVariable PL_eval_start PL_evalseq PL_exit_flags PL_exitlist
syn keyword xsVariable PL_exitlistlen PL_expect PL_faketokens PL_fdpid
syn keyword xsVariable PL_filemode PL_firstgv PL_fold PL_fold_latin1
syn keyword xsVariable PL_fold_locale PL_force_link_funcs PL_forkprocess
syn keyword xsVariable PL_formfeed PL_formtarget PL_freq PL_generation
syn keyword xsVariable PL_gensym PL_gid PL_glob_index PL_globalstash
syn keyword xsVariable PL_hash_seed PL_hintgv PL_hints PL_hv_fetch_ent_mh
syn keyword xsVariable PL_in_clean_all PL_in_clean_objs PL_in_eval
syn keyword xsVariable PL_in_load_module PL_in_my PL_in_my_stash PL_incgv
syn keyword xsVariable PL_initav PL_inplace PL_isarev PL_known_layers
syn keyword xsVariable PL_last_in_gv PL_last_lop PL_last_lop_op
syn keyword xsVariable PL_last_swash_hv PL_last_swash_klen PL_last_swash_slen
syn keyword xsVariable PL_last_swash_tmps PL_last_uni PL_lastfd
syn keyword xsVariable PL_lastgotoprobe PL_lastscream PL_laststatval
syn keyword xsVariable PL_laststype PL_lasttoke PL_latin1_lc
...
syn keyword xsVariable PL_lex_dojoin PL_lex_expect PL_lex_fakeeof
syn keyword xsVariable PL_lex_formbrack PL_lex_inpat PL_lex_inwhat PL_lex_op
syn keyword xsVariable PL_lex_repl PL_lex_starts PL_lex_state PL_lex_stuff
syn keyword xsVariable PL_linestart PL_linestr PL_localizing PL_localpatches
syn keyword xsVariable PL_lockhook PL_madskills PL_main_cv PL_main_root
syn keyword xsVariable PL_main_start PL_mainstack PL_markstack
syn keyword xsVariable PL_markstack_max PL_markstack_ptr PL_max_intro_pending
syn keyword xsVariable PL_maxo PL_maxscream PL_maxsysfd
syn keyword xsVariable PL_memory_debug_header PL_memory_wrap PL_mess_sv
syn keyword xsVariable PL_min_intro_pending PL_minus_E PL_minus_F PL_minus_a
syn keyword xsVariable PL_minus_c PL_minus_l PL_minus_n PL_minus_p
syn keyword xsVariable PL_mod_latin1_uc PL_modcount PL_modglobal
syn keyword xsVariable PL_multi_close PL_multi_end PL_multi_open
syn keyword xsVariable PL_multi_start PL_my_cxt_keys PL_my_cxt_list
syn keyword xsVariable PL_my_cxt_size PL_na PL_nexttoke PL_nexttype
...
syn keyword xsVariable PL_no_usym PL_no_wrongref PL_nomemok PL_numeric_local
syn keyword xsVariable PL_numeric_name PL_numeric_radix_sv
syn keyword xsVariable PL_numeric_standard PL_ofsgv PL_oldbufptr PL_oldname
syn keyword xsVariable PL_oldoldbufptr PL_op PL_op_desc PL_op_mask PL_op_name
syn keyword xsVariable PL_opargs PL_opfreehook PL_opsave PL_origalen
syn keyword xsVariable PL_origargc PL_origargv PL_origenviron PL_origfilename
syn keyword xsVariable PL_ors_sv PL_osname PL_pad_reset_pending PL_padix
syn keyword xsVariable PL_padix_floor PL_parser PL_patchlevel PL_peepp
syn keyword xsVariable PL_pending_ident PL_perl_destruct_level PL_perldb
syn keyword xsVariable PL_perlio PL_phase PL_phase_names PL_pidstatus
syn keyword xsVariable PL_ppaddr PL_ppid PL_preambleav PL_preambled
syn keyword xsVariable PL_profiledata PL_psig_name PL_psig_pend PL_psig_ptr
syn keyword xsVariable PL_ptr_table PL_realtokenstart PL_reentrant_buffer
syn keyword xsVariable PL_reentrant_retint PL_reg_extflags_name PL_reg_name
syn keyword xsVariable PL_reg_state PL_regdummy PL_regex_pad PL_regex_padav
syn keyword xsVariable PL_reginterp_cnt PL_registered_mros PL_regkind
syn keyword xsVariable PL_regmatch_slab PL_regmatch_state PL_rehash_seed
syn keyword xsVariable PL_rehash_seed_set PL_replgv PL_restartjmpenv
syn keyword xsVariable PL_restartop PL_rpeepp PL_rs PL_rsfp PL_rsfp_filters
syn keyword xsVariable PL_runops PL_savebegin PL_savestack PL_savestack_ix
syn keyword xsVariable PL_savestack_max PL_sawampersand PL_scopestack
syn keyword xsVariable PL_scopestack_ix PL_scopestack_max PL_scopestack_name
syn keyword xsVariable PL_screamfirst PL_screamnext PL_secondgv PL_sharehook
syn keyword xsVariable PL_sig_name PL_sig_num PL_sig_pending PL_sighandlerp
syn keyword xsVariable PL_signalhook PL_signals PL_simple PL_simple_bitmask
syn keyword xsVariable PL_skipwhite PL_slab_count PL_slabs PL_sort_RealCmp
syn keyword xsVariable PL_sortcop PL_sortstash PL_splitstr PL_srand_called
syn keyword xsVariable PL_stack_base PL_stack_max PL_stack_sp PL_start_env
syn keyword xsVariable PL_stashcache PL_statbuf PL_statcache PL_statgv
syn keyword xsVariable PL_statname PL_statusvalue PL_statusvalue_posix
syn keyword xsVariable PL_statusvalue_vms PL_stderrgv PL_stdingv PL_strtab
syn keyword xsVariable PL_sub_generation PL_sublex_info PL_subline PL_subname
syn keyword xsVariable PL_sv_arenaroot PL_sv_count PL_sv_no PL_sv_objcount
syn keyword xsVariable PL_sv_root PL_sv_serial PL_sv_undef PL_sv_yes
syn keyword xsVariable PL_sys_intern PL_taint_warn PL_tainted PL_tainting
syn keyword xsVariable PL_thisclose PL_thismad PL_thisopen PL_thisstuff
syn keyword xsVariable PL_thistoken PL_thiswhite PL_threadhook PL_timesbuf
syn keyword xsVariable PL_tmps_floor PL_tmps_ix PL_tmps_max PL_tmps_stack
syn keyword xsVariable PL_tokenbuf PL_top_env PL_toptarget PL_uid PL_unicode
syn keyword xsVariable PL_unitcheckav PL_unitcheckav_save PL_unlockhook
syn keyword xsVariable PL_unsafe PL_utf2e PL_utf8_X_L PL_utf8_X_LV
syn keyword xsVariable PL_utf8_X_LVT PL_utf8_X_LV_LVT_V PL_utf8_X_T
syn keyword xsVariable PL_utf8_X_V PL_utf8_X_begin PL_utf8_X_extend
syn keyword xsVariable PL_utf8_X_non_hangul PL_utf8_X_prepend PL_utf8_alnum
syn keyword xsVariable PL_utf8_alpha PL_utf8_ascii PL_utf8_cntrl
syn keyword xsVariable PL_utf8_digit PL_utf8_foldable PL_utf8_foldclosures
syn keyword xsVariable PL_utf8_graph PL_utf8_idcont PL_utf8_idstart
syn keyword xsVariable PL_utf8_lower PL_utf8_mark PL_utf8_perl_space
syn keyword xsVariable PL_utf8_perl_word PL_utf8_posix_digit PL_utf8_print
syn keyword xsVariable PL_utf8_punct PL_utf8_space PL_utf8_tofold
syn keyword xsVariable PL_utf8_tolower PL_utf8_totitle PL_utf8_toupper
syn keyword xsVariable PL_utf8_upper PL_utf8_xdigit PL_utf8_xidcont
syn keyword xsVariable PL_utf8_xidstart PL_utf8cache PL_utf8locale
syn keyword xsVariable PL_utf8skip PL_uudmap PL_uuemap PL_varies
syn keyword xsVariable PL_varies_bitmask PL_warn_nl PL_warn_nosemi
syn keyword xsVariable PL_warn_reserved PL_warn_uninit PL_warnhook
syn keyword xsVariable PL_watchaddr PL_watchok PL_xmlfp RETVAL SP TARG
...
syn keyword xsMacro CVf_CVGV_RC CVf_ISXSUB CVf_LVALUE CVf_METHOD CVf_NODEBUG
syn keyword xsMacro CVf_UNIQUE CVf_WEAKOUTSIDE CXINC CXTYPEMASK
...
syn keyword xsMacro C_ARRAY_LENGTH C_FAC_POSIX CopARYBASE_get CopARYBASE_set
syn keyword xsMacro CopFILE CopFILEAV CopFILEAVx CopFILEGV CopFILEGV_set
syn keyword xsMacro CopFILESV CopFILE_free CopFILE_set CopFILE_setn
syn keyword xsMacro CopHINTHASH_get CopHINTHASH_set CopHINTS_get CopHINTS_set
syn keyword xsMacro CopLABEL CopLABEL_alloc CopLINE CopLINE_dec CopLINE_inc
syn keyword xsMacro CopLINE_set CopSTASH CopSTASHPV CopSTASHPV_set
syn keyword xsMacro CopSTASH_eq CopSTASH_free CopSTASH_ne CopSTASH_set Copy
syn keyword xsMacro CopyD Ctl CvANON CvANON_off CvANON_on CvCLONE CvCLONED
syn keyword xsMacro CvCLONED_off CvCLONED_on CvCLONE_off CvCLONE_on CvCONST
syn keyword xsMacro CvCONST_off CvCONST_on CvCVGV_RC CvCVGV_RC_off
syn keyword xsMacro CvCVGV_RC_on CvDEPTH CvEVAL CvEVAL_off CvEVAL_on CvFILE
syn keyword xsMacro CvFILEGV CvFILE_set_from_cop CvFLAGS CvGV CvGV_set
...
syn keyword xsMacro FD_ISSET FD_SET FD_ZERO FEATURE_IS_ENABLED FFLUSH_NULL
syn keyword xsMacro FF_0DECIMAL FF_BLANK FF_CHECKCHOP FF_CHECKNL FF_CHOP
syn keyword xsMacro FF_DECIMAL FF_END FF_FETCH FF_HALFSPACE FF_ITEM
...
syn keyword xsMacro FILE_cnt FILE_ptr FILL_ADVANCE_NODE FILL_ADVANCE_NODE_ARG
syn keyword xsMacro FILTER_DATA FILTER_ISREADER FILTER_READ FITS_IN_8_BITS
syn keyword xsMacro FLAGS FLEXFILENAMES FOLDCHAR FOLDEQ_UTF8_LOCALE
syn keyword xsMacro FOLDEQ_UTF8_NOMIX_ASCII FOR FORMAT FPTR2DPTR FREETMPS
syn keyword xsMacro FREE_THREAD_KEY FSEEKSIZE FUNC FUNC0 FUNC0SUB FUNC1
syn keyword xsMacro FUNCMETH FUNCTION__ F_atan2_amg F_cos_amg F_exp_amg
syn keyword xsMacro F_log_amg F_pow_amg F_sin_amg F_sqrt_amg Fflush FmLINES
syn keyword xsMacro FreeOp Fstat GETATARGET GETGRENT_R_PROTO GETGRGID_R_PROTO
syn keyword xsMacro GETGRNAM_R_PROTO GETHOSTBYADDR_R_PROTO
...
syn keyword xsMacro GVf_ASSUMECV GVf_IMPORTED GVf_IMPORTED_AV GVf_IMPORTED_CV
syn keyword xsMacro GVf_IMPORTED_HV GVf_IMPORTED_SV GVf_INTRO GVf_IN_PAD
syn keyword xsMacro GVf_MULTI GVf_TIEWARNED Gconvert Gid_t_f Gid_t_sign
...
syn keyword xsMacro HAS_ALARM HAS_ASCTIME_R HAS_ATOLL HAS_BCMP HAS_BCOPY
syn keyword xsMacro HAS_BOOL HAS_BUILTIN_CHOOSE_EXPR HAS_BUILTIN_EXPECT
syn keyword xsMacro HAS_BZERO HAS_C99_VARIADIC_MACROS HAS_CHOWN HAS_CHROOT
syn keyword xsMacro HAS_CLEARENV HAS_COPYSIGNL HAS_CRYPT HAS_CTERMID
syn keyword xsMacro HAS_CTIME_R HAS_CUSERID HAS_DBL_DIG HAS_DIFFTIME
syn keyword xsMacro HAS_DIRFD HAS_DLERROR HAS_DRAND48_PROTO HAS_DUP2
syn keyword xsMacro HAS_EACCESS HAS_ENDGRENT HAS_ENDHOSTENT HAS_ENDNETENT
syn keyword xsMacro HAS_ENDPROTOENT HAS_ENDPWENT HAS_ENDSERVENT
syn keyword xsMacro HAS_FAST_STDIO HAS_FCHDIR HAS_FCHMOD HAS_FCHOWN HAS_FCNTL
syn keyword xsMacro HAS_FD_SET HAS_FGETPOS HAS_FINITE HAS_FINITEL HAS_FLOCK
syn keyword xsMacro HAS_FLOCK_PROTO HAS_FORK HAS_FPATHCONF HAS_FREXPL
...
syn keyword xsMacro HAS_GETGRENT HAS_GETGRGID_R HAS_GETGRNAM_R HAS_GETGROUPS
...
syn keyword xsMacro HAS_GETLOGIN HAS_GETLOGIN_R HAS_GETMNTENT HAS_GETNAMEINFO
...
syn keyword xsMacro HAS_GETPWENT HAS_GETPWNAM_R HAS_GETPWUID_R
syn keyword xsMacro HAS_GETSERVBYNAME HAS_GETSERVBYPORT HAS_GETSERVENT
syn keyword xsMacro HAS_GETSERV_PROTOS HAS_GETSPNAM HAS_GETSPNAM_R
syn keyword xsMacro HAS_GETTIMEOFDAY HAS_GMTIME_R HAS_GNULIBC HAS_GROUP
syn keyword xsMacro HAS_HASMNTOPT HAS_HTOVL HAS_HTOVS HAS_ILOGBL HAS_INETNTOP
syn keyword xsMacro HAS_INETPTON HAS_INET_ATON HAS_INT64_T HAS_IOCTL
syn keyword xsMacro HAS_ISASCII HAS_ISINF HAS_ISNAN HAS_ISNANL HAS_KILL
syn keyword xsMacro HAS_KILLPG HAS_LCHOWN HAS_LDBL_DIG HAS_LINK
syn keyword xsMacro HAS_LOCALECONV HAS_LOCALTIME_R HAS_LOCKF HAS_LONG_DOUBLE
syn keyword xsMacro HAS_LONG_LONG HAS_LSEEK_PROTO HAS_LSTAT HAS_MADVISE
syn keyword xsMacro HAS_MBLEN HAS_MBSTOWCS HAS_MBTOWC HAS_MEMCHR HAS_MEMCMP
syn keyword xsMacro HAS_MEMCPY HAS_MEMMOVE HAS_MEMSET HAS_MKDIR HAS_MKDTEMP
syn keyword xsMacro HAS_MKFIFO HAS_MKSTEMP HAS_MKSTEMPS HAS_MKTIME HAS_MMAP
syn keyword xsMacro HAS_MODFL HAS_MODFL_PROTO HAS_MPROTECT HAS_MSG
syn keyword xsMacro HAS_MSG_CTRUNC HAS_MSG_DONTROUTE HAS_MSG_OOB HAS_MSG_PEEK
syn keyword xsMacro HAS_MSG_PROXY HAS_MSYNC HAS_MUNMAP HAS_NICE
syn keyword xsMacro HAS_NL_LANGINFO HAS_OPEN3 HAS_PASSWD HAS_PATHCONF
syn keyword xsMacro HAS_PAUSE HAS_PIPE HAS_POLL HAS_PRCTL HAS_PRCTL_SET_NAME
syn keyword xsMacro HAS_PROCSELFEXE HAS_PTHREAD_ATTR_SETSCOPE
syn keyword xsMacro HAS_PTHREAD_UNCHECKED_GETSPECIFIC_NP HAS_PTHREAD_YIELD
syn keyword xsMacro HAS_RANDOM_R HAS_READDIR HAS_READDIR_R HAS_READLINK
syn keyword xsMacro HAS_READV HAS_RECVMSG HAS_RENAME HAS_REWINDDIR HAS_RMDIR
syn keyword xsMacro HAS_SANE_MEMCMP HAS_SBRK_PROTO HAS_SCALBNL
...
syn keyword xsMacro HAS_SIN6_SCOPE_ID HAS_SNPRINTF HAS_SOCKATMARK
syn keyword xsMacro HAS_SOCKATMARK_PROTO HAS_SOCKET HAS_SQRTL HAS_SRANDOM_R
...
syn keyword xsMacro HAS_TMPNAM_R HAS_TM_TM_GMTOFF HAS_TM_TM_ZONE HAS_TRUNCATE
syn keyword xsMacro HAS_TTYNAME_R HAS_TZNAME HAS_UALARM HAS_UMASK HAS_UNAME
syn keyword xsMacro HAS_UNSETENV HAS_USLEEP HAS_USLEEP_PROTO HAS_USTAT
syn keyword xsMacro HAS_UTIME HAS_VPRINTF HAS_VSNPRINTF HAS_VTOHL HAS_VTOHS
syn keyword xsMacro HAS_WAIT HAS_WAIT4 HAS_WAITPID HAS_WCSTOMBS HAS_WCTOMB
syn keyword xsMacro HAS_WRITEV HAVE_THREAD_INTERN HEK_BASESIZE HEK_FLAGS
syn keyword xsMacro HEK_HASH HEK_KEY HEK_LEN HEK_REHASH HEK_REHASH_on
syn keyword xsMacro HEK_UTF8 HEK_UTF8_off HEK_UTF8_on HEK_WASUTF8
syn keyword xsMacro HEK_WASUTF8_off HEK_WASUTF8_on HE_SVSLOT HEf_SVKEY
syn keyword xsMacro HINTS_REFCNT_INIT HINTS_REFCNT_LOCK HINTS_REFCNT_TERM
syn keyword xsMacro HINTS_REFCNT_UNLOCK HINT_ARYBASE HINT_BLOCK_SCOPE
...
syn keyword xsMacro IV_MIN I_32 I_ARPA_INET I_ASSERT I_CRYPT I_DIRENT I_DLFCN
...
syn keyword xsMacro I_NETINET_TCP I_POLL I_PTHREAD I_PWD I_SHADOW I_STDARG
syn keyword xsMacro I_STDDEF I_STDLIB I_STRING I_SYSLOG I_SYSUIO I_SYSUTSNAME
syn keyword xsMacro I_SYS_DIR I_SYS_FILE I_SYS_IOCTL I_SYS_MOUNT I_SYS_PARAM
syn keyword xsMacro I_SYS_POLL I_SYS_RESOURCE I_SYS_SELECT I_SYS_STAT
syn keyword xsMacro I_SYS_STATFS I_SYS_STATVFS I_SYS_TIME I_SYS_TIMES
syn keyword xsMacro I_SYS_TYPES I_SYS_UN I_SYS_VFS I_SYS_WAIT I_TERMIOS
syn keyword xsMacro I_TIME I_UNISTD I_USTAT I_UTIME I_V I_VALUES IoANY
syn keyword xsMacro IoBOTTOM_GV IoBOTTOM_NAME IoDIRP IoFLAGS IoFMT_GV
syn keyword xsMacro IoFMT_NAME IoIFP IoLINES IoLINES_LEFT IoOFP IoPAGE
syn keyword xsMacro IoPAGE_LEN IoTOP_GV IoTOP_NAME IoTYPE IoTYPE_APPEND
syn keyword xsMacro IoTYPE_CLOSED IoTYPE_IMPLICIT IoTYPE_NUMERIC IoTYPE_PIPE
syn keyword xsMacro IoTYPE_RDONLY IoTYPE_RDWR IoTYPE_SOCKET IoTYPE_STD
syn keyword xsMacro IoTYPE_WRONLY IsSet JMPENV_BOOTSTRAP JMPENV_JUMP
syn keyword xsMacro JMPENV_POP JMPENV_PUSH JOIN KEEPCOPY_PAT_MOD
syn keyword xsMacro KEEPCOPY_PAT_MODS KEEPS KEEPS_next KEEPS_next_fail
syn keyword xsMacro KEYWORD_PLUGIN_DECLINE KEYWORD_PLUGIN_EXPR
syn keyword xsMacro KEYWORD_PLUGIN_STMT KEY_AUTOLOAD KEY_BEGIN KEY_CHECK
syn keyword xsMacro KEY_CORE KEY_DESTROY KEY_END KEY_INIT KEY_NULL
syn keyword xsMacro KEY_UNITCHECK KEY___DATA__ KEY___END__ KEY___FILE__
syn keyword xsMacro KEY___LINE__ KEY___PACKAGE__ KEY_abs KEY_accept KEY_alarm
syn keyword xsMacro KEY_and KEY_atan2 KEY_bind KEY_binmode KEY_bless
syn keyword xsMacro KEY_break KEY_caller KEY_chdir KEY_chmod KEY_chomp
syn keyword xsMacro KEY_chop KEY_chown KEY_chr KEY_chroot KEY_close
syn keyword xsMacro KEY_closedir KEY_cmp KEY_connect KEY_continue KEY_cos
syn keyword xsMacro KEY_crypt KEY_dbmclose KEY_dbmopen KEY_default
...
syn keyword xsMacro LIBERAL LIBM_LIB_VERSION LIB_INVARG LIKELY LINKLIST
syn keyword xsMacro LNBREAK LOCAL LOCALE_PAT_MOD LOCALE_PAT_MODS
syn keyword xsMacro LOCALTIME_MAX LOCALTIME_MIN LOCALTIME_R
syn keyword xsMacro LOCALTIME_R_NEEDS_TZSET LOCALTIME_R_PROTO
...
syn keyword xsMacro MAX_RECURSE_EVAL_NOCHANGE_DEPTH MBOL MEMBER_TO_FPTR
syn keyword xsMacro MEM_ALIGNBYTES MEM_LOG_ALLOC MEM_LOG_FREE MEM_LOG_REALLOC
syn keyword xsMacro MEM_SIZE MEM_SIZE_MAX MEM_WRAP_CHECK MEM_WRAP_CHECK_
syn keyword xsMacro MEM_WRAP_CHECK_1 MEM_WRAP_CHECK_2 MEOL METHOD MEXTEND
syn keyword xsMacro MGVTBL_SET MGVTBL_SET_CONST_MAGIC_GET MGf_COPY MGf_DUP
syn keyword xsMacro MGf_GSKIP MGf_LOCAL MGf_MINMATCH MGf_REFCOUNTED
syn keyword xsMacro MGf_TAINTEDDIR MICRO_SIGN MINMOD MJD_OFFSET_DEBUG
syn keyword xsMacro MRO_GET_PRIVATE_DATA MSPAGAIN MULOP MULTICALL
syn keyword xsMacro MULTILINE_PAT_MOD MULTIPLICITY MUTABLE_AV MUTABLE_CV
syn keyword xsMacro MUTABLE_GV MUTABLE_HV MUTABLE_IO MUTABLE_PTR MUTABLE_SV
syn keyword xsMacro MUTEX_DESTROY MUTEX_INIT MUTEX_INIT_CALLS_MALLOC
syn keyword xsMacro MUTEX_INIT_NEEDS_MUTEX_ZEROED MUTEX_LOCK MUTEX_UNLOCK MY
syn keyword xsMacro MYSUB MYSWAP MY_CXT_CLONE MY_CXT_INDEX MY_CXT_INIT
syn keyword xsMacro MY_CXT_INIT_ARG MY_CXT_INIT_INTERP M_PAT_MODS M_VOID MgPV
syn keyword xsMacro MgPV_const MgPV_nolen_const MgTAINTEDDIR MgTAINTEDDIR_off
...
syn keyword xsMacro OP_GIMME_REVERSE OP_IS_FILETEST OP_IS_FILETEST_ACCESS
syn keyword xsMacro OP_IS_SOCKET OP_MEM_TO_REG OP_NAME OP_REFCNT_INIT
...
syn keyword xsMacro PAD_COMPNAME_PV PAD_COMPNAME_SV PAD_COMPNAME_TYPE PAD_DUP
...
syn keyword xsMacro PERL_ARGS_ASSERT_CK_UNPACK PERL_ARGS_ASSERT_CK_WARNER
...
syn keyword xsMacro PERL_ARGS_ASSERT_COP_FREE PERL_ARGS_ASSERT_CROAK_SV
...
syn keyword xsMacro PERL_ARGS_ASSERT_DO_ODDBALL PERL_ARGS_ASSERT_DO_OPEN
syn keyword xsMacro PERL_ARGS_ASSERT_DO_OPEN9 PERL_ARGS_ASSERT_DO_OPENN
syn keyword xsMacro PERL_ARGS_ASSERT_DO_OP_DUMP
...
syn keyword xsMacro PERL_ARGS_ASSERT_FETCH_COP_LABEL
syn keyword xsMacro PERL_ARGS_ASSERT_FILTER_DEL PERL_ARGS_ASSERT_FILTER_GETS
syn keyword xsMacro PERL_ARGS_ASSERT_FILTER_READ
...
syn keyword xsMacro PERL_ARGS_ASSERT_HFREEENTRIES PERL_ARGS_ASSERT_HSPLIT
...
syn keyword xsMacro PERL_ARGS_ASSERT_INIT_TM PERL_ARGS_ASSERT_INSTR
syn keyword xsMacro PERL_ARGS_ASSERT_INTUIT_METHOD
syn keyword xsMacro PERL_ARGS_ASSERT_INTUIT_MORE
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_ARRAY
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_DESTROY
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_EXTEND
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_INTERSECTION
...
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_SET_MAX
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_TRIM
syn keyword xsMacro PERL_ARGS_ASSERT_INVLIST_UNION PERL_ARGS_ASSERT_IO_CLOSE
...
syn keyword xsMacro PERL_ARGS_ASSERT_IS_GV_MAGICAL_SV
syn keyword xsMacro PERL_ARGS_ASSERT_IS_HANDLE_CONSTRUCTOR
syn keyword xsMacro PERL_ARGS_ASSERT_IS_INPLACE_AV
...
syn keyword xsMacro PERL_ARGS_ASSERT_OP_DUMP PERL_ARGS_ASSERT_OP_LINKLIST
syn keyword xsMacro PERL_ARGS_ASSERT_OP_NULL PERL_ARGS_ASSERT_OP_REFCNT_DEC
syn keyword xsMacro PERL_ARGS_ASSERT_OP_XMLDUMP PERL_ARGS_ASSERT_PACKAGE
...
syn keyword xsMacro PERL_ARGS_ASSERT_PAD_ADD_NAME
syn keyword xsMacro PERL_ARGS_ASSERT_PAD_ADD_NAME_SV
syn keyword xsMacro PERL_ARGS_ASSERT_PAD_CHECK_DUP
syn keyword xsMacro PERL_ARGS_ASSERT_PAD_FINDLEX PERL_ARGS_ASSERT_PAD_FINDMY
...
syn keyword xsMacro PERL_ARGS_ASSERT_SCALARVOID
syn keyword xsMacro PERL_ARGS_ASSERT_SCALAR_MOD_TYPE
syn keyword xsMacro PERL_ARGS_ASSERT_SCAN_BIN PERL_ARGS_ASSERT_SCAN_COMMIT
syn keyword xsMacro PERL_ARGS_ASSERT_SCAN_CONST
...
syn keyword xsMacro PERL_ARGS_ASSERT_STORE_COP_LABEL
...
syn keyword xsMacro PERL_EXIT_EXPECTED PERL_EXPORT_C PERL_FBM_TABLE_OFFSET
syn keyword xsMacro PERL_FILE_IS_ABSOLUTE PERL_FILTER_EXISTS
...
syn keyword xsMacro PERL_GPROF_MONCONTROL PERL_HASH PERL_HASH_INTERNAL
syn keyword xsMacro PERL_HASH_SEED PERL_HV_ARRAY_ALLOC_BYTES
...
syn keyword xsMacro PERL_SCNfldbl PERL_SCRIPT_MODE PERL_SET_CONTEXT
syn keyword xsMacro PERL_SET_INTERP PERL_SET_THX PERL_SHORT_MAX
syn keyword xsMacro PERL_SHORT_MIN PERL_SIGNALS_UNSAFE_FLAG
...
syn keyword xsMacro PERL_SUB_DEPTH_WARN PERL_SYS_INIT PERL_SYS_INIT3
syn keyword xsMacro PERL_SYS_INIT3_BODY PERL_SYS_INIT_BODY PERL_SYS_TERM
syn keyword xsMacro PERL_SYS_TERM_BODY PERL_TARGETARCH PERL_UCHAR_MAX
syn keyword xsMacro PERL_UCHAR_MIN PERL_UINT_MAX PERL_UINT_MIN PERL_ULONG_MAX
syn keyword xsMacro PERL_ULONG_MIN PERL_UNICODE_ALL_FLAGS PERL_UNICODE_ARGV
syn keyword xsMacro PERL_UNICODE_ARGV_FLAG PERL_UNICODE_DEFAULT_FLAGS
syn keyword xsMacro PERL_UNICODE_IN PERL_UNICODE_INOUT
syn keyword xsMacro PERL_UNICODE_INOUT_FLAG PERL_UNICODE_IN_FLAG
syn keyword xsMacro PERL_UNICODE_LOCALE PERL_UNICODE_LOCALE_FLAG
syn keyword xsMacro PERL_UNICODE_MAX PERL_UNICODE_OUT PERL_UNICODE_OUT_FLAG
syn keyword xsMacro PERL_UNICODE_STD PERL_UNICODE_STDERR
syn keyword xsMacro PERL_UNICODE_STDERR_FLAG PERL_UNICODE_STDIN
syn keyword xsMacro PERL_UNICODE_STDIN_FLAG PERL_UNICODE_STDOUT
syn keyword xsMacro PERL_UNICODE_STDOUT_FLAG PERL_UNICODE_STD_FLAG
syn keyword xsMacro PERL_UNICODE_UTF8CACHEASSERT
...
syn keyword xsMacro PERL_XS_EXPORT_C PHOSTNAME PIPESOCK_MODE PIPE_OPEN_MODE
syn keyword xsMacro PLUGEXPR PLUGSTMT PLUS PL_GNo PL_GYes PL_Gappctx
syn keyword xsMacro PL_Gcharclass PL_Gcheck PL_Gcsighandlerp PL_Gcurinterp
syn keyword xsMacro PL_Gdo_undump PL_Gdollarzero_mutex PL_Gfold_locale
syn keyword xsMacro PL_Gglobal_struct_size PL_Ghexdigit PL_Ghints_mutex
syn keyword xsMacro PL_Ginterp_size PL_Ginterp_size_5_10_0 PL_Gkeyword_plugin
syn keyword xsMacro PL_Gmalloc_mutex PL_Gmmap_page_size PL_Gmy_ctx_mutex
syn keyword xsMacro PL_Gmy_cxt_index PL_Gop_mutex PL_Gop_seq PL_Gop_sequence
syn keyword xsMacro PL_Gpatleave PL_Gperlio_debug_fd PL_Gperlio_fd_refcnt
syn keyword xsMacro PL_Gperlio_fd_refcnt_size PL_Gperlio_mutex PL_Gppaddr
syn keyword xsMacro PL_Grevision PL_Grunops_dbg PL_Grunops_std PL_Gsh_path
syn keyword xsMacro PL_Gsig_defaulting PL_Gsig_handlers_initted
syn keyword xsMacro PL_Gsig_ignoring PL_Gsig_trapped PL_Gsigfpe_saved
syn keyword xsMacro PL_Gsubversion PL_Gsv_placeholder PL_Gthr_key
syn keyword xsMacro PL_Gtimesbase PL_Guse_safe_putenv PL_Gversion
syn keyword xsMacro PL_Gveto_cleanup PL_Gwatch_pvx PL_IArgv PL_ICmd PL_IDBcv
syn keyword xsMacro PL_IDBgv PL_IDBline PL_IDBsignal PL_IDBsingle PL_IDBsub
syn keyword xsMacro PL_IDBtrace PL_IDir PL_IEnv PL_ILIO PL_IMem PL_IMemParse
syn keyword xsMacro PL_IMemShared PL_IOpPtr PL_IOpSlab PL_IOpSpace PL_IProc
syn keyword xsMacro PL_ISock PL_IStdIO PL_ISv PL_IXpv PL_Iamagic_generation
syn keyword xsMacro PL_Ian PL_Iapiversion PL_Iargvgv PL_Iargvout_stack
syn keyword xsMacro PL_Iargvoutgv PL_Ibasetime PL_Ibeginav PL_Ibeginav_save
syn keyword xsMacro PL_Iblockhooks PL_Ibody_arenas PL_Ibody_roots
syn keyword xsMacro PL_Ibodytarget PL_Ibreakable_sub_gen PL_Icheckav
syn keyword xsMacro PL_Icheckav_save PL_Ichopset PL_Iclocktick
syn keyword xsMacro PL_Icollation_ix PL_Icollation_name
syn keyword xsMacro PL_Icollation_standard PL_Icollxfrm_base
syn keyword xsMacro PL_Icollxfrm_mult PL_Icolors PL_Icolorset PL_Icompcv
syn keyword xsMacro PL_Icompiling PL_Icomppad PL_Icomppad_name
syn keyword xsMacro PL_Icomppad_name_fill PL_Icomppad_name_floor
syn keyword xsMacro PL_Icop_seqmax PL_Icryptseen PL_Icurcop PL_Icurcopdb
syn keyword xsMacro PL_Icurpad PL_Icurpm PL_Icurstack PL_Icurstackinfo
syn keyword xsMacro PL_Icurstash PL_Icurstname PL_Icustom_op_descs
syn keyword xsMacro PL_Icustom_op_names PL_Icustom_ops PL_Icv_has_eval
syn keyword xsMacro PL_Idbargs PL_Idebstash PL_Idebug PL_Idebug_pad
syn keyword xsMacro PL_Idef_layerlist PL_Idefgv PL_Idefoutgv PL_Idefstash
syn keyword xsMacro PL_Idelaymagic PL_Idestroyhook PL_Idiehook PL_Idoswitches
syn keyword xsMacro PL_Idowarn PL_Idumper_fd PL_Idumpindent PL_Ie_script
syn keyword xsMacro PL_Iefloatbuf PL_Iefloatsize PL_Iegid PL_Iencoding
syn keyword xsMacro PL_Iendav PL_Ienvgv PL_Ierrgv PL_Ierrors PL_Ieuid
syn keyword xsMacro PL_Ieval_root PL_Ieval_start PL_Ievalseq PL_Iexit_flags
syn keyword xsMacro PL_Iexitlist PL_Iexitlistlen PL_Ifdpid PL_Ifilemode
syn keyword xsMacro PL_Ifirstgv PL_Iforkprocess PL_Iformfeed PL_Iformtarget
syn keyword xsMacro PL_Igeneration PL_Igensym PL_Igid PL_Iglob_index
syn keyword xsMacro PL_Iglobalstash PL_Ihash_seed PL_Ihintgv PL_Ihints
syn keyword xsMacro PL_Ihv_fetch_ent_mh PL_Iin_clean_all PL_Iin_clean_objs
syn keyword xsMacro PL_Iin_eval PL_Iin_load_module PL_Iincgv PL_Iinitav
syn keyword xsMacro PL_Iinplace PL_Iisarev PL_Iknown_layers PL_Ilast_in_gv
syn keyword xsMacro PL_Ilast_swash_hv PL_Ilast_swash_key PL_Ilast_swash_klen
syn keyword xsMacro PL_Ilast_swash_slen PL_Ilast_swash_tmps PL_Ilastfd
syn keyword xsMacro PL_Ilastgotoprobe PL_Ilastscream PL_Ilaststatval
syn keyword xsMacro PL_Ilaststype PL_Ilocalizing PL_Ilocalpatches
syn keyword xsMacro PL_Ilockhook PL_Imadskills PL_Imain_cv PL_Imain_root
syn keyword xsMacro PL_Imain_start PL_Imainstack PL_Imarkstack
syn keyword xsMacro PL_Imarkstack_max PL_Imarkstack_ptr PL_Imax_intro_pending
syn keyword xsMacro PL_Imaxo PL_Imaxscream PL_Imaxsysfd
syn keyword xsMacro PL_Imemory_debug_header PL_Imess_sv PL_Imin_intro_pending
syn keyword xsMacro PL_Iminus_E PL_Iminus_F PL_Iminus_a PL_Iminus_c
syn keyword xsMacro PL_Iminus_l PL_Iminus_n PL_Iminus_p PL_Imodcount
syn keyword xsMacro PL_Imodglobal PL_Imy_cxt_keys PL_Imy_cxt_list
syn keyword xsMacro PL_Imy_cxt_size PL_Ina PL_Inomemok PL_Inumeric_local
syn keyword xsMacro PL_Inumeric_name PL_Inumeric_radix_sv
syn keyword xsMacro PL_Inumeric_standard PL_Iofsgv PL_Ioldname PL_Iop
syn keyword xsMacro PL_Iop_mask PL_Iopfreehook PL_Iopsave PL_Iorigalen
syn keyword xsMacro PL_Iorigargc PL_Iorigargv PL_Iorigenviron
syn keyword xsMacro PL_Iorigfilename PL_Iors_sv PL_Iosname
syn keyword xsMacro PL_Ipad_reset_pending PL_Ipadix PL_Ipadix_floor
syn keyword xsMacro PL_Iparser PL_Ipatchlevel PL_Ipeepp
syn keyword xsMacro PL_Iperl_destruct_level PL_Iperldb PL_Iperlio PL_Iphase
syn keyword xsMacro PL_Ipidstatus PL_Ippid PL_Ipreambleav PL_Iprofiledata
syn keyword xsMacro PL_Ipsig_name PL_Ipsig_pend PL_Ipsig_ptr PL_Iptr_table
syn keyword xsMacro PL_Ireentrant_buffer PL_Ireentrant_retint PL_Ireg_state
syn keyword xsMacro PL_Iregdummy PL_Iregex_pad PL_Iregex_padav
syn keyword xsMacro PL_Ireginterp_cnt PL_Iregistered_mros PL_Iregmatch_slab
syn keyword xsMacro PL_Iregmatch_state PL_Irehash_seed PL_Irehash_seed_set
syn keyword xsMacro PL_Ireplgv PL_Irestartjmpenv PL_Irestartop PL_Irpeepp
syn keyword xsMacro PL_Irs PL_Irunops PL_Isavebegin PL_Isavestack
syn keyword xsMacro PL_Isavestack_ix PL_Isavestack_max PL_Isawampersand
syn keyword xsMacro PL_Iscopestack PL_Iscopestack_ix PL_Iscopestack_max
syn keyword xsMacro PL_Iscopestack_name PL_Iscreamfirst PL_Iscreamnext
syn keyword xsMacro PL_Isecondgv PL_Isharehook PL_Isig_pending
syn keyword xsMacro PL_Isighandlerp PL_Isignalhook PL_Isignals PL_Islab_count
syn keyword xsMacro PL_Islabs PL_Isort_RealCmp PL_Isortcop PL_Isortstash
syn keyword xsMacro PL_Isplitstr PL_Isrand_called PL_Istack_base
syn keyword xsMacro PL_Istack_max PL_Istack_sp PL_Istart_env PL_Istashcache
syn keyword xsMacro PL_Istatbuf PL_Istatcache PL_Istatgv PL_Istatname
syn keyword xsMacro PL_Istatusvalue PL_Istatusvalue_posix PL_Istatusvalue_vms
syn keyword xsMacro PL_Istderrgv PL_Istdingv PL_Istrtab PL_Isub_generation
syn keyword xsMacro PL_Isubline PL_Isubname PL_Isv_arenaroot PL_Isv_count
syn keyword xsMacro PL_Isv_no PL_Isv_objcount PL_Isv_root PL_Isv_serial
syn keyword xsMacro PL_Isv_undef PL_Isv_yes PL_Isys_intern PL_Itaint_warn
syn keyword xsMacro PL_Itainted PL_Itainting PL_Ithreadhook PL_Itimesbuf
syn keyword xsMacro PL_Itmps_floor PL_Itmps_ix PL_Itmps_max PL_Itmps_stack
syn keyword xsMacro PL_Itop_env PL_Itoptarget PL_Iuid PL_Iunicode
syn keyword xsMacro PL_Iunitcheckav PL_Iunitcheckav_save PL_Iunlockhook
syn keyword xsMacro PL_Iunsafe PL_Iutf8_X_L PL_Iutf8_X_LV PL_Iutf8_X_LVT
syn keyword xsMacro PL_Iutf8_X_LV_LVT_V PL_Iutf8_X_T PL_Iutf8_X_V
syn keyword xsMacro PL_Iutf8_X_begin PL_Iutf8_X_extend PL_Iutf8_X_non_hangul
syn keyword xsMacro PL_Iutf8_X_prepend PL_Iutf8_alnum PL_Iutf8_alpha
syn keyword xsMacro PL_Iutf8_ascii PL_Iutf8_cntrl PL_Iutf8_digit
syn keyword xsMacro PL_Iutf8_foldable PL_Iutf8_foldclosures PL_Iutf8_graph
syn keyword xsMacro PL_Iutf8_idcont PL_Iutf8_idstart PL_Iutf8_lower
syn keyword xsMacro PL_Iutf8_mark PL_Iutf8_perl_space PL_Iutf8_perl_word
syn keyword xsMacro PL_Iutf8_posix_digit PL_Iutf8_print PL_Iutf8_punct
syn keyword xsMacro PL_Iutf8_space PL_Iutf8_tofold PL_Iutf8_tolower
syn keyword xsMacro PL_Iutf8_totitle PL_Iutf8_toupper PL_Iutf8_upper
syn keyword xsMacro PL_Iutf8_xdigit PL_Iutf8_xidcont PL_Iutf8_xidstart
syn keyword xsMacro PL_Iutf8cache PL_Iutf8locale PL_Iwarnhook PL_Iwatchaddr
syn keyword xsMacro PL_Iwatchok PL_Ixmlfp PL_No PL_OP_SLAB_ALLOC PL_Yes
syn keyword xsMacro PL_appctx PL_body_roots PL_bostr PL_colors PL_cshlen
syn keyword xsMacro PL_csighandlerp PL_curinterp PL_dirty PL_do_undump
syn keyword xsMacro PL_dollarzero_mutex PL_global_struct_size PL_hexdigit
syn keyword xsMacro PL_hints_mutex PL_interp_size PL_interp_size_5_10_0
syn keyword xsMacro PL_keyword_plugin PL_last_swash_key PL_malloc_mutex
syn keyword xsMacro PL_mmap_page_size PL_my_ctx_mutex PL_my_cxt_index PL_nrs
syn keyword xsMacro PL_op_mutex PL_op_seq PL_op_sequence PL_patleave
syn keyword xsMacro PL_perlio_debug_fd PL_perlio_fd_refcnt
syn keyword xsMacro PL_perlio_fd_refcnt_size PL_perlio_mutex PL_reg_curpm
...
syn keyword xsMacro PL_reg_start_tmpl PL_reg_starttry PL_regeol PL_reginput
syn keyword xsMacro PL_reglastcloseparen PL_reglastparen PL_regoffs
syn keyword xsMacro PL_regsize PL_revision PL_runops_dbg PL_runops_std
syn keyword xsMacro PL_sh_path PL_sig_defaulting PL_sig_handlers_initted
syn keyword xsMacro PL_sig_ignoring PL_sig_trapped PL_sigfpe_saved
syn keyword xsMacro PL_subversion PL_sv_placeholder PL_thr_key PL_timesbase
syn keyword xsMacro PL_use_safe_putenv PL_version PL_veto_cleanup
syn keyword xsMacro PL_watch_pvx PMFUNC PM_GETRE PM_SETRE PMf_BASE_SHIFT
syn keyword xsMacro PMf_COMPILETIME PMf_CONST PMf_CONTINUE PMf_EVAL
syn keyword xsMacro PMf_EXTENDED PMf_FOLD PMf_GLOBAL PMf_KEEP PMf_KEEPCOPY
syn keyword xsMacro PMf_MAYBE_CONST PMf_MULTILINE PMf_NONDESTRUCT PMf_ONCE
syn keyword xsMacro PMf_RETAINT PMf_SINGLELINE PMf_USED POPBLOCK POPEVAL
syn keyword xsMacro POPFORMAT POPLOOP POPMARK POPSTACK POPSTACK_TO POPSUB
syn keyword xsMacro POPSUBST POP_MULTICALL POP_SAVEARRAY POPi POPl POPn POPp
syn keyword xsMacro POPpbytex POPpconstx POPpx POPq POPs POPu POPul POPuq
syn keyword xsMacro POSTDEC POSTINC POWOP PP PREC_LOW PREDEC
syn keyword xsMacro PREGf_CUTGROUP_SEEN PREGf_IMPLICIT PREGf_NAUGHTY
syn keyword xsMacro PREGf_SKIP PREGf_VERBARG_SEEN PREINC PREVOPER
syn keyword xsMacro PRINTF_FORMAT_NULL_OK PRIVATEREF PRIVLIB PRIVLIB_EXP
syn keyword xsMacro PRIVSHIFT PROCSELFEXE_PATH PRUNE PSEUDO PTHREAD_ATFORK
syn keyword xsMacro PTHREAD_ATTR_SETDETACHSTATE PTHREAD_CREATE
...
syn keyword xsMacro PUSHp PUSHs PUSHu PUTBACK PWGECOS PWPASSWD Pause
syn keyword xsMacro PeRl_CaTiFy PeRl_StGiFy PerlDir_chdir PerlDir_close
...
syn keyword xsMacro Perl_pow Perl_pp_accept Perl_pp_andassign Perl_pp_avalues
syn keyword xsMacro Perl_pp_bind Perl_pp_bit_xor Perl_pp_chmod Perl_pp_chomp
...
syn keyword xsMacro PmopSTASH_free PmopSTASH_set Poison PoisonFree PoisonNew
syn keyword xsMacro PoisonWith QR_PAT_MODS QUADKIND QUAD_IS_INT
syn keyword xsMacro QUAD_IS_INT64_T QUAD_IS_LONG QUAD_IS_LONG_LONG QWLIST
...
syn keyword xsMacro SAVECOPARYBASE SAVECOPFILE SAVECOPFILE_FREE SAVECOPLINE
syn keyword xsMacro SAVECOPSTASH SAVECOPSTASH_FREE SAVEDELETE SAVEDESTRUCTOR
...
syn keyword xsMacro SAVEt_COP_ARYBASE SAVEt_DELETE SAVEt_DESTRUCTOR
syn keyword xsMacro SAVEt_DESTRUCTOR_X SAVEt_FREECOPHH SAVEt_FREEOP
syn keyword xsMacro SAVEt_FREEPV SAVEt_FREESV SAVEt_GENERIC_PVREF
syn keyword xsMacro SAVEt_GENERIC_SVREF SAVEt_GP SAVEt_GVSV SAVEt_HELEM
...
syn keyword xsMacro SAVEt_PARSER SAVEt_PPTR SAVEt_REGCONTEXT SAVEt_RE_STATE
syn keyword xsMacro SAVEt_SAVESWITCHSTACK SAVEt_SET_SVFLAGS
syn keyword xsMacro SAVEt_SHARED_PVREF SAVEt_SPTR SAVEt_STACK_CXPOS
syn keyword xsMacro SAVEt_STACK_POS SAVEt_SV SAVEt_SVREF SAVEt_VPTR SBOL
syn keyword xsMacro SCAN_DEF SCAN_REPL SCAN_TR SCHEDULE SCHED_YIELD
syn keyword xsMacro SCOPE_SAVES_SIGNAL_MASK SEEK_CUR SEEK_END SEEK_SET
syn keyword xsMacro SELECT_MIN_BITS SEOL SETERRNO SETGRENT_R_PROTO
...
syn keyword xsMacro SETTARG SETUID_SCRIPTS_ARE_SECURE_NOW SET_MARK_OFFSET
syn keyword xsMacro SET_NUMERIC_LOCAL SET_NUMERIC_STANDARD SET_THR
syn keyword xsMacro SET_THREAD_SELF SETi SETn SETp SETs SETsv SETsvUN SETu
syn keyword xsMacro SHARP_S_SKIP SHIFTOP SHORTSIZE SH_PATH SIGABRT SIGILL
syn keyword xsMacro SIG_NAME SIG_NUM SIG_SIZE SINGLE_PAT_MOD SITEARCH
syn keyword xsMacro SITEARCH_EXP SITELIB SITELIB_EXP SITELIB_STEM SIZE_ALIGN
syn keyword xsMacro SIZE_ONLY SKIP SKIP_next SKIP_next_fail SLOPPYDIVIDE
syn keyword xsMacro SOCKET_OPEN_MODE SPACE SPACEA SPACEL SPACEU SPAGAIN
syn keyword xsMacro SPRINTF_RETURNS_STRLEN SRAND48_R_PROTO SRANDOM_R_PROTO
syn keyword xsMacro SSCHECK SSGROW SSNEW SSNEWa SSNEWat SSNEWt SSPOPBOOL
syn keyword xsMacro SSPOPDPTR SSPOPDXPTR SSPOPINT SSPOPIV SSPOPLONG SSPOPPTR
syn keyword xsMacro SSPOPUV SSPTR SSPTRt SSPUSHBOOL SSPUSHDPTR SSPUSHDXPTR
syn keyword xsMacro SSPUSHINT SSPUSHIV SSPUSHLONG SSPUSHPTR SSPUSHUV
syn keyword xsMacro SS_ACCVIO SS_DEVOFFLINE SS_IVCHAN SS_NORMAL ST STANDARD_C
syn keyword xsMacro STAR STARTPERL START_EXTERN_C START_MY_CXT STATIC
...
syn keyword xsMacro STATUS_UNIX_SET STDCHAR STDIO_PTR_LVALUE
syn keyword xsMacro STDIO_PTR_LVAL_SETS_CNT STDIO_STREAM_ARRAY STD_PAT_MODS
...
syn keyword xsMacro STR_WITH_LEN SUB SUBST_TAINT_BOOLRET SUBST_TAINT_PAT
syn keyword xsMacro SUBST_TAINT_REPL SUBST_TAINT_RETAINT SUBST_TAINT_STR
syn keyword xsMacro SUBVERSION SUCCEED SUSPEND SVTYPEMASK SV_CHECK_THINKFIRST
...
syn keyword xsMacro SWITCHSTACK SYMBIAN SYSTEM_GMTIME_MAX SYSTEM_GMTIME_MIN
syn keyword xsMacro SYSTEM_LOCALTIME_MAX SYSTEM_LOCALTIME_MIN S_IEXEC S_IFIFO
syn keyword xsMacro S_IFMT S_IREAD S_IRGRP S_IROTH S_IRUSR S_IRWXG S_IRWXO
syn keyword xsMacro S_IRWXU S_ISBLK S_ISCHR S_ISDIR S_ISFIFO S_ISGID S_ISLNK
syn keyword xsMacro S_ISREG S_ISSOCK S_ISUID S_IWGRP S_IWOTH S_IWRITE S_IWUSR
syn keyword xsMacro S_IXGRP S_IXOTH S_IXUSR S_PAT_MODS Safefree Semctl
syn keyword xsMacro Sigjmp_buf Siglongjmp Sigsetjmp Size_t_size StGiFy
syn keyword xsMacro StashHANDLER Stat Strerror Strtol Strtoul StructCopy
syn keyword xsMacro SvAMAGIC SvAMAGIC_off SvAMAGIC_on SvANY SvCANEXISTDELETE
syn keyword xsMacro SvCOMPILED SvCOMPILED_off SvCOMPILED_on SvCUR SvCUR_set
...
syn keyword xsMacro USE_HASH_SEED USE_HEAP_INSTEAD_OF_STACK USE_ITHREADS
syn keyword xsMacro USE_LARGE_FILES USE_LEFT USE_LOCALE USE_LOCALE_COLLATE
syn keyword xsMacro USE_LOCALE_CTYPE USE_LOCALE_NUMERIC USE_PERLIO
syn keyword xsMacro USE_REENTRANT_API USE_SEMCTL_SEMID_DS USE_SEMCTL_SEMUN
syn keyword xsMacro USE_STAT_BLOCKS USE_STAT_RDEV USE_STDIO USE_STDIO_BASE
syn keyword xsMacro USE_STDIO_PTR USE_STRUCT_COPY USE_SYSTEM_GMTIME
syn keyword xsMacro USE_SYSTEM_LOCALTIME USE_THREADS USE_TM64
syn keyword xsMacro USE_UTF8_IN_NAMES UTF8SKIP UTF8_ACCUMULATE UTF8_ALLOW_ANY
syn keyword xsMacro UTF8_ALLOW_ANYUV UTF8_ALLOW_CONTINUATION
...
syn keyword xsMacro VTBL_regexp VTBL_sig VTBL_sigelem VTBL_substr VTBL_sv
syn keyword xsMacro VTBL_taint VTBL_uvar VTBL_vec WARN_ALL WARN_ALLstring
syn keyword xsMacro WARN_AMBIGUOUS WARN_BAREWORD WARN_CLOSED WARN_CLOSURE
syn keyword xsMacro WARN_DEBUGGING WARN_DEPRECATED WARN_DIGIT WARN_EXEC
syn keyword xsMacro WARN_EXITING WARN_GLOB WARN_ILLEGALPROTO WARN_IMPRECISION
syn keyword xsMacro WARN_INPLACE WARN_INTERNAL WARN_IO WARN_LAYER WARN_MALLOC
syn keyword xsMacro WARN_MISC WARN_NEWLINE WARN_NONCHAR WARN_NONEstring
...
syn keyword xsMacro WIN32SCK_IS_STDSCK WITH_THR WITH_THX WNOHANG WORD
syn keyword xsMacro WSTOPSIG WTERMSIG WUNTRACED XHvTOTALKEYS XOPd_xop_class
...
syn keyword xsMacro XS_DYNAMIC_FILENAME XS_VERSION_BOOTCHECK XSprePUSH
syn keyword xsMacro XTENDED_PAT_MOD XopDISABLE XopENABLE XopENTRY
syn keyword xsMacro XopENTRY_set XopFLAGS YADAYADA YIELD YYEMPTY
syn keyword xsMacro YYSTYPE_IS_DECLARED YYSTYPE_IS_TRIVIAL YYTOKENTYPE Zero
syn keyword xsMacro ZeroD _ _CANNOT _CC_ALNUMC_A _CC_ALNUMC_L1 _CC_ALPHA_A
syn keyword xsMacro _CC_ALPHA_L1 _CC_BLANK_A _CC_BLANK_L1 _CC_CHARNAME_CONT
syn keyword xsMacro _CC_CNTRL_A _CC_CNTRL_L1 _CC_DIGIT_A _CC_GRAPH_A
syn keyword xsMacro _CC_GRAPH_L1 _CC_IDFIRST_A _CC_IDFIRST_L1 _CC_LOWER_A
syn keyword xsMacro _CC_LOWER_L1 _CC_NONLATIN1_FOLD _CC_OCTAL_A _CC_PRINT_A
syn keyword xsMacro _CC_PRINT_L1 _CC_PSXSPC_A _CC_PSXSPC_L1 _CC_PUNCT_A
syn keyword xsMacro _CC_PUNCT_L1 _CC_SPACE_A _CC_SPACE_L1 _CC_UPPER_A
...
syn keyword xsMacro gv_fetchmethod gv_fetchpvn gv_fetchpvs gv_fullname3
syn keyword xsMacro gv_stashpvs htoni htonl htons htovl htovs hv_delete
syn keyword xsMacro hv_delete_ent hv_exists hv_exists_ent hv_fetch
...
syn keyword xsMacro my_stat my_strlcat my_strlcpy my_vsnprintf newAV newHV
syn keyword xsMacro newIO newRV_inc newSUB newSVpvn_utf8 newSVpvs
syn keyword xsMacro newSVpvs_flags newSVpvs_share newXSproto ntohi ntohl
syn keyword xsMacro ntohs opASSIGN op_getmad open opendir pTHX_1 pTHX_2
syn keyword xsMacro pTHX_3 pTHX_4 pTHX_5 pTHX_6 pTHX_7 pTHX_8 pTHX_9
...
syn keyword xsMacro packWARN3 packWARN4 pad_peg padadd_NO_DUP_CHECK
syn keyword xsMacro padadd_OUR padadd_STATE padnew_CLONE padnew_SAVE
syn keyword xsMacro padnew_SAVESUB panic_write2 pause pclose pipe popen
syn keyword xsMacro prepare_SV_for_RV pthread_attr_init
syn keyword xsMacro pthread_condattr_default pthread_create
...
syn keyword xsMacro vfprintf vtohl vtohs wait what_TRICKYFOLD
syn keyword xsMacro what_TRICKYFOLD_safe what_len_TRICKYFOLD
